...
tiles_tr = [1,3,5,7,8,10,11,13,14,16,18,20] #[1,3,5,8,11,13,14,20]
tiles_val = [4,6,19]
...
# plt.savefig('mask_tiles.png')
# plt.figure(figsize=(10,5))
# plt.imshow(final_mask1, cmap = 'jet')
# plt.savefig('final_mask1.png')
...
# print('im_idx.shape:', im_idx.shape)
# print(im_idx)
# print('patches_idx:', patches_idx.shape)
# print(patches_idx)
# print('patches_mask:', patches_mask.shape)
# print(patches_mask)
...
root_path = '/share_epsilon/amandalucas/pix2pix/Sentinel2/samples/' 
...
# load training patches into X_Train
# load validation patches into Y_Train
...
valid_gen = valid_datagen.flow(np.expand_dims(X_valid, axis = -1), y_valid, batch_size=batch_size, shuffle=False)

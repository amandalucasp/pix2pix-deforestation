...
# plt.figure()
# plt.imshow(re / 255.0)
npy_path = pathlib.Path('/share_alpha_2/amandalucas/pix2pix/Sentinel2/samples')
# inp2, re2 = load_npy(str(npy_path/'training_data/pairs/0.npy'))
# print(inp.shape, re.shape)
# print(inp2.shape, re.shape)
...
for example_input, example_target in test_dataset.take(1):
  generate_images(generator, example_input, example_target, 'sample.png')
...
for inp, tar in test_dataset.take(5):
  generate_images(generator, inp, tar, 'generated_images/' + str(counter) + '.png')
  counter+=1